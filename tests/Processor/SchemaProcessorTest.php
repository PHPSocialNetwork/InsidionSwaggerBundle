...
class SchemaProcessorTest extends TestCase
{
    ...
    {
        $this->assertNotNull($this->container->get('swagger.processor.schema', Container::NULL_ON_INVALID_REFERENCE));
    }

    public function testSwaggerDefinitionBuilderServiceBuildNotNull()
    {
        $this->assertNotNull($this->container->get('swagger.processor.schema', Container::NULL_ON_INVALID_REFERENCE)->process());
    }
}